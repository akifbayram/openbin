...
Multi-user, local-first PWA for organizing physical storage bins with QR codes and real-time sync. Create an account, join a shared home, print QR labels, and scan them to instantly look up contents. Data syncs via ElectricSQL to PostgreSQL, while the client stays fast and offline-capable.
...
- **Accounts + shared homes** — Register/login, create or join a home, and share bins with members
...
2. **Create/join a home** — Invite or join members to share bins
