...
Once running, register an account, create a location, add bins, and [print QR labels](/guide/print-labels). See the [User Guide](/guide/) for details on AI setup, bulk operations, export/import, and API keys.
