...
### Users
Home organizers managing household storage — garages, closets, attics, craft rooms, pantries. Two modes: **setup** (creating bins, printing labels, photographing contents) and **lookup** (scanning a QR code to find what's inside). Setup at a desk; lookup standing in front of shelves, often one-handed on phone. Speed and clarity matter most during lookup.

### Brand Personality
**Premium, polished, precise.** Should feel like a first-party Apple app. No clutter, no visual noise. Every element earns its place.

### Aesthetic Direction
- **Visual tone**: iOS 26 Liquid Glass — translucent surfaces with depth, subtle blur, crisp typography
- **Reference**: Apple Reminders, Apple Home — native feel, glass effects, system-level polish
- **Anti-references**: Cluttered dashboards, gratuitous gradients, "startup SaaS" aesthetics, dark corporate enterprise UIs
- **Accent**: Purple (#5e2fe0) — sparingly for interactive elements and AI features
- **Typography**: DM Sans headings (personality), system SF stack body (clarity)

### Design Principles
1. **Clarity over cleverness** — Prefer familiar iOS patterns. Hierarchy and spacing do the communication work.
2. **Quiet confidence** — Subtle glass effects, restrained animation, generous whitespace.
3. **Mobile-first, scan-fast** — QR scan → bin contents must be instant, legible, one-handed.
4. **Systematic consistency** — Every color, radius, shadow, spacing from the token system. Not a token = a bug.
5. **Earn every pixel** — No decorative elements without function. Premium feel from precision, not ornamentation.
