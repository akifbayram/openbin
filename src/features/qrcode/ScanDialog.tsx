        ...
        <Dialog.Positioner>
          ...
          {error ? (
            <Card>
              <CardContent className="py-8">
                <div className="flex flex-col items-center gap-5 text-center">
                  <div className="h-14 w-14 rounded-full bg-red-500 bg-opacity-10 flex items-center justify-center">
            ...
            <Card>
              <CardContent className="py-8">
                <div className="flex flex-col items-center gap-5 text-center">
                  <div className="h-14 w-14 rounded-full bg-purple-600 dark:bg-purple-500 bg-opacity-10 flex items-center justify-center">
                    <ScanLine className="h-7 w-7 text-purple-600 dark:text-purple-400" />
                  </div>
                  <div className="space-y-1.5">
                    <p className="text-[17px] font-semibold">{t.Bin} Not Found</p>
          ...
          <div className="mt-4">
            <Label className="text-[15px] font-semibold normal-case tracking-normal mb-3 block">
              Manual Lookup
            </Label>
