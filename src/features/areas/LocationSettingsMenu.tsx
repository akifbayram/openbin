    ...
    return (
      <Tooltip content="Leave" side="bottom">
        <Button
          ...
          aria-label="Leave"
          className={compact
            ? 'h-7 w-7 rounded-[var(--radius-xs)] text-[var(--destructive)]'
        ...
        >
          ...
          {!compact && (
            <>
              ...
              <ChevronRight className={cn('h-3.5 w-3.5 ml-1 transition-transform', isOpen && 'rotate-90')} />
            </>
          )}
        </Button>
      </Tooltip>
