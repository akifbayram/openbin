...
export function TagColorPicker({ currentColor, onColorChange }: TagColorPickerProps) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {visible && (
        <div className={`${animating === 'exit' ? 'animate-popover-exit' : 'animate-popover-enter'} absolute right-0 top-full mt-1 z-50 rounded-[var(--radius-lg)] p-2 shadow-lg min-w-[180px] space-y-2`}>
