...
const META_LABEL = 'text-[12px] font-medium text-[var(--text-tertiary)]';
    ...
    <section className="flex flex-col gap-6" data-tour="qr-section">
      ...
      <div className="flex flex-col gap-3.5">
        <div className={META_FIELD}>
          <span className={META_LABEL}>Code</span>
        ...
        <div className={cn(META_FIELD, autoSave.savedFields.has('areaId') && 'animate-save-flash')}>
          <span className={META_LABEL}>{t.Area}</span>
          {canEdit ? (
            <AreaPicker
        ...
        {canChangeVisibility && (
          <div className={cn(META_FIELD, autoSave.savedFields.has('visibility') && 'animate-save-flash')}>
            <span className={META_LABEL}>Visibility</span>
            <VisibilityPicker
