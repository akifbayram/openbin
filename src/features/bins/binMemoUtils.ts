...
export function areCommonBinCardPropsEqual(
  prev: { bin: Bin; selectable?: boolean; selected?: boolean; index?: number; onSelect?: unknown; searchQuery?: string; isVisible?: unknown },
  next: { bin: Bin; selectable?: boolean; selected?: boolean; index?: number; onSelect?: unknown; searchQuery?: string; isVisible?: unknown },
): boolean {
  return (
